...
<!-- Fonts -->
    ...
    <script src="https://kit.fontawesome.com/9dd01b031a.js" crossorigin="anonymous"></script>
...
<div id="app">
    <nav class="navbar navbar-expand-md navbar-light bg-white">
        <div class="container">
            <a class="navbar-brand font-weight-bold text-primary" href="{{ url('/') }}">CRM</a>
                ...
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item">
                        <a href="{{ action('CustomersController@index') }}"
                           class="nav-link {{ Request::is('megrendelok*') || Request::is('/') ? 'active' : '' }}">
                    ...
                    <li class="nav-item">
                        <a href="{{ action('ItemsController@index') }}"
                           class="nav-link {{ Request::is('termekek*') ? 'active' : '' }}">
                                <span class="icon mr-2">
